...
Flashcard application for ISTQB CTFL 4.0 exam preparation. A self-contained HTML page with embedded CSS and JavaScript that loads flashcard data from istqb.json and provides an interactive card-flip interface with previous/next navigation and keyboard support.
