...
Core JavaScript logic for the ISTQB CTFL 4.0 Practice Exam quiz application. Handles quiz state management, question loading from JSON, countdown timer, option selection with correct/incorrect feedback animations, score tracking, skip/next/exit controls, and results display.
